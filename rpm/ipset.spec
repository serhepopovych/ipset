...
%changelog
* Fri Mar 06 2020 Serhey Popovych <serhe.popovych@gmail.com> - 7.6-2
- Add ipset-services package to support persistent data store and restore.
- Drop %preun part with checks if ipsets being used by iptables.
- Add sentences to %description of specific packages to explain their purpose.
...
- Change library package name to match sonames:
  o Change libipset11 to libipset13 to match sonames
  o debian/libipset13.symbols: Update new symbols
- Update Vcs-{Browser,Git} with github.com/serhepopovych.
